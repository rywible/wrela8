...
pub const SURFACE: &[SurfaceSymbol] = &[
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_prepare",
        origin: SurfaceOrigin::ImagePixels,
        signature: "(renderer: usize, frame_index: u64) -> bool",
        empty_body: "    return false",
        injected: true,
    },
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_invalidate",
        origin: SurfaceOrigin::ImagePixels,
        signature: "(renderer: usize) -> bool",
        empty_body: "    return false",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_status",
        origin: SurfaceOrigin::ImagePixels,
        signature: "(renderer: usize) -> [u64; 4]",
        empty_body: "    return [0; 4]",
        injected: true,
    },
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_word_load",
        origin: SurfaceOrigin::ImagePixels,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_word_store",
        origin: SurfaceOrigin::ImagePixels,
        signature: "(renderer: usize, word: usize, value: u64) -> bool",
        empty_body: "    return false",
        injected: true,
    },
    SurfaceSymbol {
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_transfer_capacity",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_transparent_color",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_tail_radiance",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_ordered_layers",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_update_all",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_update_all_impl",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_accumulate32",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_commit",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_candidates",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_trace",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_floor",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_store_cell",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_snapshot_word",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_dependency_snapshot",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_gi_floor",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_gi_pair",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_gi_level",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_probe_gi",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_f32_transfer_compose",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
    ...
    SurfaceSymbol {
        name: "__wrela_pixels_p10_f32_transfer_balanced64",
        origin: SurfaceOrigin::CoreRender,
        signature: "",
        empty_body: "",
        injected: true,
