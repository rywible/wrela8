//! P-1 Pixels walking skeleton.
//!
//! This installs the compiler boundaries and accepts exactly one directly
//! marked plane. It is deliberately replaced by the symbolic compiler in
//! P2-P8; expanding this matcher is not a supported extension path.
