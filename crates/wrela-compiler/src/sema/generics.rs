...
fn build_consts_program(mctx: &ModuleCtx) -> crate::sema::typed::TypedProgram {
    ...
    // plans/M7.md item G, decision 14: prelude enums for const-generic
    ...
    match v {
        ...
        crate::eval::Value::Enum(idx, payload) if payload.is_empty() => {
            ...
            let variant = match enum_name {
                ...
                _ => {
                    // plans/M7.md item G, decision 14: prelude enums
...
pub(crate) fn instantiate_struct(
    ...
    // =====================================================================
    // plans/M7.md item G, decision 14: expand deferred `comptime if`
