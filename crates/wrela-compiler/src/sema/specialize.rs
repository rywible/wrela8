...
//! - **plans/M7.md item G, decision 14:** a member/statement `comptime if`
...
fn check_comptime_vocabulary(
    ...
    match e {
        ...
        // plans/M7.md item G, decision 14: `DriverMode.Irq` / `Target.*` /
    ...
    match member {
        Member::ComptimeIf(c) => {
            ...
            if condition_uses_enclosing_const_generic(&c.cond, enclosing_const_generics) {
                // Decision 14: defer for per-instantiation expansion.
...
// ===========================================================================
// plans/M7.md item G, decision 14: per-instantiation expansion of deferred
